		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							...
							<input class="s-text7 size6 p-l-23 p-r-50" type="submit" name="search-product" placeholder="Search Products...">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                    ...
                    $query = mysql_query($con, $sqlT);
                    $total = mysqli_num_rows($queryT);
                    

                    $numPaginas = ceil($total/$registro);

                    $inicio = ($registro*$numPaginas)-$registro;
